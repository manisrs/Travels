/* MIT — sindresorhus/strip-json-comments v5.0.1 (vendored; no npm required) */
...
export default function stripJsonComments(
  ...
  const strip = whitespace ? stripWithWhitespace : () => "";
  ...
  return (
    result +
    buffer +
    (isInsideComment ? strip(jsonString, offset, jsonString.length) : jsonString.slice(offset))
  );
}
